...
def Arf2AddInitMs(builder, initMs):
    builder.PrependUint32Slot(0, initMs, 0)

def AddInitMs(builder, initMs):
    Arf2AddInitMs(builder, initMs)

def Arf2AddEndMs(builder, endMs):
    builder.PrependUint32Slot(1, endMs, 0)

def AddEndMs(builder, endMs):
    Arf2AddEndMs(builder, endMs)

def Arf2AddTotalHints(builder, totalHints):
    builder.PrependUint32Slot(2, totalHints, 0)

def AddTotalHints(builder, totalHints):
    Arf2AddTotalHints(builder, totalHints)

def Arf2AddWgoRequired(builder, wgoRequired):
    builder.PrependUint32Slot(3, wgoRequired, 0)

def AddWgoRequired(builder, wgoRequired):
    Arf2AddWgoRequired(builder, wgoRequired)

def Arf2AddHgoRequired(builder, hgoRequired):
    builder.PrependUint32Slot(4, hgoRequired, 0)

def AddHgoRequired(builder, hgoRequired):
    Arf2AddHgoRequired(builder, hgoRequired)

def Arf2AddWish(builder, wish):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(wish), 0)
...
def Arf2AddSpecialHint(builder, specialHint):
    builder.PrependUint32Slot(7, specialHint, 0)

def AddSpecialHint(builder, specialHint):
    Arf2AddSpecialHint(builder, specialHint)

def Arf2AddDtsLayer1(builder, dtsLayer1):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(dtsLayer1), 0)
...
def Arf2AddDtsLayer2(builder, dtsLayer2):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(dtsLayer2), 0)
...
def Arf2AddIndex(builder, index):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(index), 0)
