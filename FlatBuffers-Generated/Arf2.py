...
def Arf2AddHint(builder, hint):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(hint), 0)
...
def Arf2AddSpecialHint(builder, specialHint):
    builder.PrependUint16Slot(6, specialHint, 0)

def AddSpecialHint(builder, specialHint):
    Arf2AddSpecialHint(builder, specialHint)

def Arf2AddDtsLayer1(builder, dtsLayer1):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(dtsLayer1), 0)
...
def Arf2AddDtsLayer2(builder, dtsLayer2):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(dtsLayer2), 0)
...
def Arf2AddIndex(builder, index):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(index), 0)
